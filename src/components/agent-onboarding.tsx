...
function makeStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    onboardTitle:  { fontSize: 16, fontWeight: '800', color: c.text },
    onboardSub:    { fontSize: 11, color: c.textMuted },
    skipTxt:       { fontSize: 13, fontWeight: '600', color: c.textMuted },
    stepBody:    { flex: 1 },
    ...
    stepTitle:   { fontSize: 22, fontWeight: '800', color: c.text, textAlign: 'center', marginBottom: 8 },
    stepSub:     { fontSize: 13, color: c.textMuted, textAlign: 'center', lineHeight: 20 },
    infoCard:    { flexDirection: 'row', alignItems: 'flex-start', gap: 10, backgroundColor: ACCENT + '15', borderRadius: 12, padding: 12, borderWidth: 1, borderColor: ACCENT + '44', marginBottom: 20 },
    infoCardIcon: { fontSize: 18 },
    infoCardTxt:  { flex: 1, fontSize: 12, color: EARTH, lineHeight: 18, fontWeight: '500' },
    field:     { marginBottom: 18 },
    labelRow:  { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 7 },
    label:     { fontSize: 12, fontWeight: '700', color: c.textSub, flex: 1 },
    optional:  { fontWeight: '400', color: c.textFaint },
    input:     { borderWidth: 1.5, borderColor: c.border, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 13, fontSize: 14, color: c.text, backgroundColor: '#fff' },
    monoInput: { fontFamily: Platform.OS === 'ios' ? 'Courier' : 'monospace', letterSpacing: 1 },
    inputError: { borderColor: '#ef4444', backgroundColor: '#fef2f2' },
    inputValid: { borderColor: PRIMARY, backgroundColor: PRIMARY + '0a' },
    ...
    vehiclePill:       { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 99, borderWidth: 1.5, borderColor: c.borderMid, backgroundColor: '#fff' },
    vehiclePillActive: { borderColor: PRIMARY, backgroundColor: PRIMARY + '15' },
    vehiclePillTxt:    { fontSize: 13, fontWeight: '600', color: c.textSub },
    vehiclePillTxtActive: { color: PRIMARY },
    ...
    kycNote:    { backgroundColor: c.bgSubtle, borderRadius: 12, padding: 14, marginBottom: 8 },
    kycNoteTxt: { fontSize: 12, color: c.textMuted, lineHeight: 18 },
    stepFooter: { flexDirection: 'row', gap: 10, paddingTop: 8 },
    backBtn:    { paddingHorizontal: 20, paddingVertical: 15, borderRadius: 12, borderWidth: 1.5, borderColor: c.borderMid, alignItems: 'center', justifyContent: 'center' },
    backBtnTxt: { fontSize: 14, fontWeight: '600', color: c.textSub },
